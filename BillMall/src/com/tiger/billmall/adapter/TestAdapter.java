...
//	private static Logger log = Logger.getLogger(Activity.class);
	...
	private ArrayList<PhoneShow> newsList;
	private LayoutInflater inflater = null;
	private Activity activity;
	
	public TestAdapter(Activity activity, ArrayList<PhoneShow> newsList) {
	...
	@Override
	public PhoneShow getItem(int position) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		//获取position对应的数据
		PhoneShow news = getItem(position);
